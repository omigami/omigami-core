...
from omigami.spectra_matching.spec2vec.tasks import ModelRegister
...
def test_register_model(word2vec_model, tmpdir):
    ...
    assert "spec2vec" in os.listdir(
        f"{path}/{run_id}/artifacts/model/code/omigami/spectra_matching"
    )
