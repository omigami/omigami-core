...
from spec2vec_mlops.helper_classes.data_storer import SpectrumIDStorer, SpectrumStorer
...
def convert_to_documents_task(feast_core_url: str, n_decimals: int) -> SpectrumDocument:
    ...
    spectrum = spectrum_storer.read_clean_data(spectrum_ids=all_spectrum_ids)
